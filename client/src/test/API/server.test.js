...
describe('GET/ hotels', () => {
	...
	test('should return JSON array', (done) => {
	...
	test('should get all hotels', (done) => {
		return request(app).get('/api/hotels')
			.expect(200)
			.then((res) => {
	...
	test('should return hotels with correct properties', (done) => {
		return request(app).get('/api/hotels')
			.expect(200)
			.then((res) => {
	...
	test('should return 404 for non-objects ids', () => {
	...
	test('should return 200 for correct hotel id', () => {
