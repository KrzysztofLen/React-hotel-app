...
class AddHotelReview extends Component<Props, {}> {
  ...
  private onSubmitSurvey = (e: any) => {
    this.props.submitSurvey(this.props.addHotelFormValues, this.props.history);
  };
      ...
      <div className={'hotel-form'}>
        <div className={'hotel-form__container'}>
          ...
          <div className={'hotel-review__wrapper'}>
            ...
            <div className={'hotel-review__send'} onClick={this.onSubmitSurvey}>
              <img className={'hotel-review__sendIcon'} src={send} alt="" />
              Send
              <Link to="/" className={'hotel-form__close'}>
                &#x2715;
              </Link>
            </div>
          </div>
