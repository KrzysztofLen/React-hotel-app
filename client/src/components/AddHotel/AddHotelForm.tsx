		...
		return (
			<div className="hotel-form__formValueBox">
				<div>
					...
					<input type="text" placeholder="Burj Al Arab"
					       onChange={this.handleChange.bind(this, "hotel_name")}
					       value={this.state.fields["hotel_name"] || ""}
					       className={this.state.errors["hotel_name"] ? "input input__error" : "input"}/>
				</div>
				<div>
					<label htmlFor="">Hotel adress</label>
					<input type="text" placeholder="Jumeirah St - Dubai"
					       onChange={this.handleChange.bind(this, "hotel_adress")}
					       value={this.state.fields["hotel_adress"] || ""}
					       className={this.state.errors["hotel_adress"] ? "input input__error" : "input"}/>
				</div>
				<div>
					...
					<input type="text" placeholder="Dubai"
					       ...
					       className={this.state.errors["hotel_city"] ? "input input__error" : "input"}/>
				</div>
				<div>
					<label htmlFor="">Hotel province</label>
					<input type="text" placeholder={"Jumeirah"}
					       onChange={this.handleChange.bind(this, "hotel_province")}
					       value={this.state.fields["hotel_province"] || ""}
					       className={this.state.errors["hotel_province"] ? "input input__error" : "input"}/>
				</div>
				<div>
					<label htmlFor="">Hotel description</label>
					<input type="text" placeholder={"This is the best hotel on the world"}
					       onChange={this.handleChange.bind(this, "hotel_description")}
					       value={this.state.fields["hotel_description"] || ""}
					       className={this.state.errors["hotel_description"] ? "input input__error" : "input"}/>
				</div>
			</div>
		)
	}
		...
		return (
			<div className="hotel-form__formValueBox">
				<div>
					...
					<input type="number" min={0} placeholder={"172"}
					       onChange={this.handleChange.bind(this, "hotel_price")}
					       value={this.state.fields["hotel_price"] || 0}
					       className={this.state.errors["hotel_price"] ? "input input__error" : "input"}/>
				</div>
				<div>
					...
					<input type="number" min={0} placeholder={"10"}
					       ...
					       className={this.state.errors["hotel_distance"] ? "input input__error" : "input"}/>
				</div>
				<div>
					...
					<input type="number" min={0} placeholder={"5"}
					       ...
					       className={this.state.errors["hotel_stars"] ? "input input__error" : "input"}/>
				</div>
				<div>
					<label htmlFor="">Hotel rating</label>
					<input type="number" min={0} placeholder={"8.9"}
					       onChange={this.handleChange.bind(this, "hotel_rating")}
					       value={this.state.fields["hotel_rating"] || 0}
					       className={this.state.errors["hotel_rating"] ? "input input__error" : "input"}/>
				</div>
				<div>
					...
					<input type="number" min={0} placeholder={"1200"}
					       ...
					       className={this.state.errors["hotel_reviews"] ? "input input__error" : "input"}/>
				</div>
			</div>
		)
	}
	...
	render() {
        ...
        return (
			<div className={"hotel-form"}>
				{isErrors !== true && <Messages type={"danger"} message={ErrorMessageEnum.provideValue}/>}
